...
#include "Point2d.h"
   ...
   // copy constructor: 
   //   set x and y values to the same as those given in the parameter
   // The parameter MUST BE pass-by-constant-reference
   Point2d::Point2d ( const Point2d &p )
   {
      printf ("In copy constructor Point2d( Point2d(%d,%d) )\n", p.x, p.y);
      x = p.x;
      y = p.y;
   }
   ...
   Point2d::Point2d ( ) 
   {
      printf ("In default constructor Point2d()\n");
      x = 0;
      y = 0;
   }
