...
public class MyMoney{
	...
	public MyMoney(String cashFilename, int...sizeAndType){
		...
		this.printArray(sizeAndType[1]); // error was here when printing cashvalues array when only interest values was inputted
	}
	...
	public MyMoney(String cashFilename, String interestFilename, int...size){
		...
		System.out.println("Values in file "+cashFilename);
		this.printArray(1);
		System.out.println("Values in file "+interestFilename);
		this.printArray(2);
	}
